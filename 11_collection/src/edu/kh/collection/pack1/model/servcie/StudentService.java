package edu.kh.collection.pack1.model.servcie;
...
public class StudentService {
	...
	// * 인터페이스 객체생성 X, 부모 참조변수 0
	
	// java.util.ArrayList : 배열 형태 List (가장 대표적인 List 자식 클래스)
	
	// new ArrayList() : 기본생성자 -> 기본 크기가 10 짜리
	...
	*/
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				case 7 : sortByAge(); break;	// Comparable 사용
				case 8 : sortByName(); break;	// Comparator 사용
	...
	public String addStudent() throws InputMismatchException{
		...
		System.out.print("성별(M/F) : ");	// 'M' or 'F'
	 ...
	 * - studentList 범위 내 인덱스 번호인지 검사, 초과했다면 
	 * 	 "범위를 넘어선 값을 입력할 수 없습니다" 문자열 반환
	 ...
	 * 검색할 이름 입력박아 studentList에서 껴내온 Student 객체의 name값이 같은지 비교
	...
	public void sortByName() {
		...
		// Student::getName -> 메서드 래퍼런스(Method Reference)
