...
public class ByteService {
	...
	// -> IOException 예외처리 구문을 작성하는것이 필수
	...
	public void fileByteOutput() {
		...
		try {
			...
			sb.append("가나다라마바사아\n");
			sb.append("와 자바\n");
			sb.append("진짜로 정말로 정말로\n");
			
			// 출력방법 1 : 한 글자(2byte)씩 파일로 출력
			// -> 2byte 범주의 문자는 바이트 기반 스트림 통과 시
			// 데이터 손실이 발생해서 글자가 깨지는 문제가 발생
			
			// StringBuilder -> String 반환
	...
	public void fileByteInput() {
		...
		try {
			...
			// byte -> 자바에서 정수형
			// 다루기 힘들기때문에 정수의 기본형인 int로 변환해서 사용
